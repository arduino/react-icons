...
export function IconSocialRssFeedNormal(props) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 32 32" fill="none" {...props}>
      ...
      />
      <path
        d="M4 16C7.1826 16 10.2348 17.2643 12.4853 19.5147C14.7357 21.7652 16 24.8174 16 28H20C20 23.7565 18.3143 19.6869 15.3137 16.6863C12.3131 13.6857 8.24346 12 4 12V16Z"
        fill="currentColor"
      />
      <path
